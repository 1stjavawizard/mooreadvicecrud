...
if(isset($_GET['update_me'])){
	$id = $_GET['update_me'];
}
$datas =  mysqli_query($mooreadvice, "SELECT `id`, `username`, `password`, `date_inserted` FROM `users` where id ='$id' limit 1");

$fetch = mysqli_fetch_assoc($datas);
?>
<!DOCTYPE html>
<html lang="en">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="username" value="<?php echo $fetch['username'];?>" required>
                                                    <div class="invalid-feedback">
                                                        Please choose a username.
                                                    </div>
													<input type="hidden" name="id" id="user_id" value="<?php echo $fetch['id'];?>"/>
                                                </div>
                                            </div>
                                        </div>
                                     
                                        <button class="btn btn-primary mt-3" id="update_all" type="submit">Submit form</button>
                                    </form>
